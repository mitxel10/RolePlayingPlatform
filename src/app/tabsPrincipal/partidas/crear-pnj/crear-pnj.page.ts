...
@Component({
  selector: 'app-crear-pnj',
  templateUrl: './crear-pnj.page.html',
  styleUrls: ['./crear-pnj.page.scss'],
})
export class CrearPnjPage implements OnInit {
  ...
  irListaPnjs() {
    this.router.navigate(['tabs/partidas/' + this.idPartida +  '/lista-pnj']);
  }
}
